  ...
  return (
    <PageContainer>
      ...
      <Paragraph>
        ...
        <br/><br/>
        Blanketten mailas därefter till <LinkTo type={'Mail'}>andrahand@brf-flygplansfabriken.se</LinkTo>. Godkänd uthyrningstid är max ett
        år. Handläggningstiden är ca 30
        dagar.
      </Paragraph>
      ...
      <Paragraph>
        Brf Flygplansfabriken tar ut en månadsavgift för varje påbörjad månad som andrahandsuthyrning pågår.
        Avgiften för dig som hyr ut i andra hand är 10 % av gällande prisbasbelopp per helår.
        Avgiften utgår för varje påbörjad månad av andrahandsuthyrningen.
        Månadsavgiften för andrahandsuthyrning kommer att läggas till på månadsavin för föreningsavgiften under den period du ansökt om att
