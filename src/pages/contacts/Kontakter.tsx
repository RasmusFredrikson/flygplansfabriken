    ...
    return (
        <PageContainer>
            ...
            <Paragraph>
                ...
                Telefon:{" "}
                <LinkTo type={"Tel"}>
                    {Fastighetsservice.phone[0].number}
                </LinkTo>{" "}
                ({Fastighetsservice.phone[0].openingHours})
                <br />
                Telefon:{" "}
                <LinkTo type={"Tel"}>
                    {Fastighetsservice.phone[1].number}
                </LinkTo>{" "}
                ({Fastighetsservice.phone[1].openingHours})
                <br />
                Webbsida för felamnälan:{" "}
                <Link href={Fastighetsservice.homePage}>
                    {Fastighetsservice.homePage}
                </Link>
                <br />
                ...
                <LinkTo type={"Mail"}>{styrelsen.email}</LinkTo>
                <br />
            ...
            <SubHeading>Felparkerade bilar utomhus</SubHeading>
            ...
            <Paragraph>
                ...
                <br />
                Uppge adress, ditt telefonnummer och vad ärendet gäller, t.ex.
                om någon har parkerat på din plats.
            </Paragraph>
            ...
            <Paragraph>
                ...
                <br />
                Telefon:{" "}
                <LinkTo type={"Tel"}>{elevator.phone[0].number}</LinkTo>
            </Paragraph>
            ...
            <Paragraph>
                ...
                <br />
                Telefon:{" "}
                <LinkTo type={"Tel"}>{lockService.phone[0].number}</LinkTo>
            </Paragraph>
        </PageContainer>
    );
};
